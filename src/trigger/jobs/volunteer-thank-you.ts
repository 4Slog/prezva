  ...
  run: async (payload) => {
    ...
    for (const v of recipients) {
      ...
      const hoursLineHtml = hours
        ? `<li>⏱️ <strong>Time contributed:</strong> ${hours}</li>`
        : ''
      const roleLineHtml = role ? `<li>🎯 <strong>Your role:</strong> ${role}</li>` : ''
        ...
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;">
          ...
          <div style="background:#0F2236;padding:24px 32px;border-radius:0 0 12px 12px;color:#CBD5E1;">
            ...
            <p style="font-size:15px;">
              <strong style="color:#F0F4F8;">${payload.eventTitle}</strong> wouldn't have happened without people like you.
              On behalf of <strong style="color:#F0F4F8;">${payload.orgName}</strong>, thank you for giving your time on ${fmtDate(payload.eventDate)}.
            </p>
            ...
            <p style="color:#94A3B8;font-size:13px;">
              With gratitude,<br/>${payload.orgName}
            </p>
