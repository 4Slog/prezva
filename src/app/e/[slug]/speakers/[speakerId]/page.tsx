    ...
    <div style={{ minHeight:'100vh', background:'var(--pz-bg)' }}>
      <div style={{ background:'var(--pz-surface)', color:'#fff', padding:'2rem 1.5rem' }}>
        <div style={{ maxWidth:720, margin:'0 auto' }}>
          <Link href={'/e/'+slug+'/speakers'} style={{ color:'var(--pz-teal)', textDecoration:'none', fontSize:13 }}>Back to speakers</Link>
          <div style={{ display:'flex', gap:'1.5rem', alignItems:'center', marginTop:'1rem' }}>
            <div style={{ width:80, height:80, borderRadius:'50%', background:'rgba(255,255,255,0.1)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:28, color:'var(--pz-teal)', fontWeight:700, overflow:'hidden', flexShrink:0 }}>
