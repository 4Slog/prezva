  ...
  return (
    ...
    >
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm" style={{ color: 'var(--pz-muted)' }}>Sign in to your Prezva account</p>
      </div>
      ...
      <form action={formAction} className="space-y-4">
        ...
        <div className="flex justify-end">
          <Link href="/forgot-password" className="text-sm hover:underline" style={{ color: 'var(--pz-teal)' }}>
            Forgot password?
          </Link>
        </div>
        <button
      ...
      <p className="mt-6 text-center text-sm" style={{ color: 'var(--pz-muted)' }}>
        ...
        <Link href="/signup" className="font-medium hover:underline" style={{ color: 'var(--pz-teal)' }}>
          Sign up
        </Link>
      </p>
    </div>
