  ...
  if (isPermissionError(error)) {
    return (
      <div style={{ padding: 40, textAlign: 'center' }}>
        ...
        <Link href="/dashboard" style={{ display: 'inline-block', background: 'var(--pz-teal)', color: 'var(--pz-on-accent)', border: 'none', borderRadius: 8, padding: '8px 20px', fontWeight: 700, textDecoration: 'none', fontSize: 14 }}>Return to dashboard</Link>
      </div>
    )
  }
