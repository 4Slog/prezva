  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10">
      ...
      <section className="mb-8 rounded-xl border border-[#1E3A5F] bg-[#112240] p-6">
        ...
        {!hasStripe ? (
          <div className="rounded-lg px-4 py-3" style={{ background: '#EF444422', border: '1px solid var(--pz-error)' }}>
          ...
          <>
            ...
            {!fullyEnabled && (
              <div className="rounded-lg px-4 py-3 mb-4" style={{ background: '#F59E0B22', border: '1px solid var(--pz-warning-fill)' }}>
      ...
      <section className="rounded-xl border border-[#1E3A5F] bg-[#112240] p-6">
        ...
        <div className="flex items-baseline gap-2 mb-2">
          ...
          <span className="ml-2 px-2 py-0.5 rounded-full text-xs font-semibold bg-[#2DD4BF]/10 text-[#2DD4BF]">Professional</span>
        </div>
        ...
        <p className="text-xs text-[#64748B]">
          Need help? Contact{' '}
          <a href="mailto:billing@prezva.app" className="text-[#2DD4BF] hover:underline">billing@prezva.app</a>
        </p>
      </section>
    </div>
  )
