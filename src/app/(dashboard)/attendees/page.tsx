...
export const metadata = { title: 'Attendees — Prezva' }
...
export default async function AttendeesPage() {
  ...
  if (!events || events.length === 0) {
    return (
      <div>
        <h1 className="text-2xl font-bold mb-6" style={{ color: 'var(--pz-text)' }}>Attendees</h1>
        <EmptyState
          icon="👥"
          title="No events yet"
          description="Create an event to start managing attendees."
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-2" style={{ color: 'var(--pz-text)' }}>Attendees</h1>
