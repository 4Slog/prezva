  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      ...
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-xl font-bold text-[var(--pz-text)]">Leaderboard</h1>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {leaders.map((l, i) => (
            <div key={l.userId} className="pz-card p-4" style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
              <span style={{ width: 28, height: 28, borderRadius: '50%', background: i < 3 ? 'var(--pz-teal)' : 'var(--pz-border)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, fontWeight: 700, color: i < 3 ? 'var(--pz-on-accent)' : 'var(--pz-muted)', flexShrink: 0 }}>
