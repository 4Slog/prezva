...
// prezvaEventDate, prezvaEventName and prezvaCompletionDate are intentionally
// NOT listed here yet. FIELD_KEYS is the runtime completeness check in
// getGhlOrgConfig, and orgs provisioned before a field existed hold fewer keys
// — listing one would throw for them on the sync and sweep paths. Promote a key
// here only after every ghl_org_config row has been re-provisioned. Until then
// each write site guards on truthiness of its own field id instead.
